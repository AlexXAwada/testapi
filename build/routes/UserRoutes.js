...
class UserRouter {
    ...
    getUsers(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const users = yield User_1.default.find().populate('transactions', 'title url -_id').exec();
            res.json(users);
        });
    }
    getUser(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const user = yield User_1.default.findOne({ username: req.params.username }).populate('transactions').exec();
            res.json(user);
        });
    }
    createUser(req, res) {
